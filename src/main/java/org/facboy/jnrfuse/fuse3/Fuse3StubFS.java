...
public class Fuse3StubFS extends AbstractFuse3FS {
    @Override
    @NotImplemented
    ...
    @Override
    @NotImplemented
    public int rename(String oldpath, String newpath, Fuse3RenameFlags flags) {
        return 0;
    }
    ...
    @Override
    @NotImplemented
    public int chmod(String path, @mode_t long mode, FuseFileInfo fi) {
        return 0;
    }

    @Override
    @NotImplemented
    public int chown(String path, @uid_t long uid, @gid_t long gid, FuseFileInfo fi) {
        return 0;
    }

    @Override
    @NotImplemented
    public int truncate(String path, @off_t long size, FuseFileInfo fi) {
        return 0;
    }
    ...
    @Override
    @NotImplemented
    public int readdir(String path, Pointer buf, FuseFillDir filter, @off_t long offset, FuseFileInfo fi, Fuse3ReaddirFlags flags) {
        return 0;
    }
    ...
    @Override
    @NotImplemented
    public Pointer init(Pointer conn, Pointer cfg) {
        return null;
    }
